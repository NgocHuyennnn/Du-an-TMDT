...
export default function TaiKhoanCaNhan() {
  ...
  console.log("USER PROFILE:", user); // thêm để kiểm tra
  ...
  setProfileData((prev) => ({
    ...
    storeName: user.ShopName || user.shopName || "",
    taxCode: user.TaxCode || user.taxCode || "",
  ...
  setTimeout(() => {
    ...
    const newUser = {
      ...
      ShopName: profileData.storeName,
    ...
    setMsg({
      type:"success",
      text:"Cập nhật hồ sơ tài khoản thành công!"
    });
          ...
          <div className="bg-slate-50/70 p-6 md:p-8 border-b md:border-b-0 md:border-r border-slate-200/60 flex flex-col items-center text-center justify-between">
            <div className="w-full space-y-6">
              ...
              <div className="relative w-24 h-24 mx-auto group">
                ...
                <button
                  type="button"
                  className="absolute bottom-0 right-0 bg-blue-600 p-2 rounded-full text-white hover:bg-blue-700 shadow-xs cursor-pointer transition-all"
                >
                  <Camera size={12} />
                </button>
              </div>
            ...
            <div className="space-y-5">
              <div className="space-y-1">
                ...
                <p className="text-xs font-medium text-slate-400">
                  Quản lý và cập nhật thông tin vận hành của bạn trên hệ thống.
                </p>
              </div>
              ...
              {msg.text && (
                <div
                  className={`border rounded-xl p-3 text-xs font-semibold flex items-center gap-2 animate-in fade-in duration-200 ${
                    msg.type === "success"
                ...
                >
                  <span
                    className={`w-1.5 h-1.5 rounded-full shrink-0 ${msg.type === "success" ? "bg-emerald-500" : "bg-red-500"}`}
                  />
                  <span>{msg.text}</span>
                </div>
              )}
              ...
              <form onSubmit={handleSaveProfile} className="space-y-4">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  <div className="space-y-1">
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="w-full bg-slate-50 border border-slate-200 rounded-xl pl-10 pr-4 h-10 text-xs font-medium text-slate-800 focus:outline-hidden focus:border-blue-500 focus:bg-white transition-all"
                      />
                    </div>
                  </div>
                  ...
                  <div className="space-y-1 sm:col-span-2">
                    <label className="text-xs font-black text-slate-400 block">
                      Email đăng nhập hệ thống (Cố định)
                    </label>
                    <div className="relative">
                      <span className="absolute inset-y-0 left-0 pl-3.5 flex items-center text-slate-400 pointer-events-none">
                        <Mail size={14} />
                      ...
                      <input
                        ...
                        disabled
                        className="w-full bg-slate-100 border border-slate-200 rounded-xl pl-10 pr-4 h-10 text-xs font-medium text-slate-400 cursor-not-allowed select-none"
                      />
                    </div>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  <div className="space-y-1 sm:col-span-2">
                    <label className="text-xs font-black text-slate-700 block">
                      Địa chỉ đặt văn phòng / kho trung chuyển
                    </label>
                    <div className="relative">
                      <span className="absolute inset-y-0 left-0 pl-3.5 flex items-center text-slate-400 pointer-events-none">
                        <MapPin size={14} />
          ...
          <div className="bg-white rounded-2xl p-6 max-w-sm w-full relative z-10 shadow-xl border border-slate-100 animate-in zoom-in-95 duration-150">
            ...
            <div className="text-center space-y-3 mt-2">
              ...
              <p className="text-xs text-slate-500 font-medium leading-relaxed">
                Bạn có chắc chắn muốn đăng xuất khỏi tài khoản quản trị hệ thống
                hiện tại không?
              </p>
            </div>
